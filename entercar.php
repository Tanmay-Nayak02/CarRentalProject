...
<body style="background-color:#8ce99a">
      ...
      if (isset($_SESSION['login_client'])) {
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            ...
            <li>
              <a style="font-size:18px;font-weight:800" href="#"><span class="glyphicon glyphicon-user"></span> Welcome
                <?php echo $_SESSION['login_client']; ?>
              </a>
            </li>
            <li>
              <ul class="nav navbar-nav navbar-right">
                <li><a style="font-size:18px;font-weight:800" href="#" class="dropdown-toggle active"
                    data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span
                      class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
            ...
            <li>
              <a style="font-size:18px;font-weight:800" href="logout.php"><span
  ...
  <div class="container" style="margin-top: 65px;">
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area" style="background-color:#ebfbee">
        <form role="form" action="entercar1.php" enctype="multipart/form-data" method="POST">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="non_ac_price_per_day" name="non_ac_price_per_day"
    ...
    <div class="col-md-12" style="float: none; margin: 0 auto;">
      <div style="background-color:#ebfbee" class="form-area" style="padding: 0px 100px 100px 100px;">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <?php echo $row["ac_price"]; ?>
                      </td>
                      <td>
                        <?php echo $row["non_ac_price"]; ?>
                      </td>
                      <td>
                        <?php echo $row["ac_price_per_day"]; ?>
                      </td>
                      <td>
                        <?php echo $row["non_ac_price_per_day"]; ?>
                      </td>
                      <td>
