                        ...
                        <li>
                            <ul class="nav navbar-nav navbar-right">
                                <li><a style="font-size:18px;font-weight:800" href="#" class="dropdown-toggle active"
                                        ...
                                        aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel
                                        <span class="caret"></span> </a>
                                    <ul class="dropdown-menu">
                                        <li> <a style="font-size:18px;font-weight:800" href="entercar.php">Add Car</a></li>
                                        <li> <a style="font-size:18px;font-weight:800" href="enterdriver.php"> Add
                                                Driver</a></li>
                ...
                ?>
                    <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a style="font-size:18px;font-weight:800" href="#"><span
                    ...
                    <form role="form" action="customer_registered_success.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_name"><span class="text-danger" style="margin-right: 5px;">*</span>
                                    Full Name: </label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="aadhar"><span class="text-danger"
                                        style="margin-right: 5px;">*</span> Aadhar Number: </label>
                                <div class="input-group">
                                    <input class="form-control" id="customer_address" type="text"
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="licences"><span class="text-danger"
                                        style="margin-right: 5px;">*</span> Licences Number: </label>
                                <div class="input-group">
                                    <input class="form-control" id="customer_address" type="text"
                                        name="licence_no" placeholder="Licences Number" required="">
                                    <span class="input-group-btn">
                                        <label class="btn btn-primary"><span class="glyphicon glyphicon-home"
                                                aria-hidden="true"></label>
                                    </span>
