...
<body ng-app="" style="background-color:#1864ab"> 
...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area " style="background-color:#74c0fc">
      ...
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6 style="color:#fff"><strong style="color:#fff">Note:</strong> You will be charged with extra <span class="text-danger">Rs. 500</span> for each day after the due date ends.</h6>
        </div>
    </div>
